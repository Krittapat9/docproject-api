...
app.post('/staff',(req,res) => {
  db.query(
    ...
    [req.body.username, req.body.firstname, req.body.lastname, req.body.password, req.body.pin], 
    (err,result)=>{
...
app.post('/login',async(req,res)=>{
  ...
  try{
    const result=await db.query('SELECT * FROM staff WHERE username=$1 AND password=$2',[username,password]);
...
app.post('/patient', (req,res) => {
  db.query(
    ...
    [req.body.staff_id, req.body.firstname, req.body.lastname, req.body.sex, req.body.date_of_birth, req.body.hospital_number, req.body.date_of_registration],
    (err,result)=>{
      res.json(result.affectedRows)
    })
})
